...
public final class SchemaClientAcquireLease {
    ...
    public static void main(String[] args) {
        try {
            ...
            SchemaLease lease =
                client.acquireLease(new SchemaLeaseRequest(options.owner(), options.metadata()));
    ...
    private static void startHeartbeat(LeaseCliOptions options) {
        ...
        try {
            ...
            System.out.printf("Started heartbeat watcher pid: %d (maven-pid=%d) logging to %s%n",
                currentPid,
    ...
    private static Path defaultLog(Path leaseFile) {
        ...
        return parent != null ? parent.resolve("schema-client-heartbeat.log") :
